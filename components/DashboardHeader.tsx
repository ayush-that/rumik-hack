...
export default async function DashboardHeader() {
    ...
    return (
        <header className="fixed top-0 inset-x-0 mx-auto max-w-[480px] flex items-center gap-3 px-4 py-3 bg-[var(--background)] border-b border-x border-[var(--card-border)] z-50">
