...
export default function BottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-white border-t border-x border-[var(--card-border)] flex justify-around py-2 z-50">
